...
Nu till spelets huvudfunktion! Dags att bygga så att vi kan tävla med vår Pokémon. Det finns tre viktiga aspekter att tänka på när det kommer till duelleringen:
...
5. Under duelleringens gång ska följande rapporteras till användaren
    - Aktuell ställning i `hp` för de båda Pokémonen
...
**Varje attack ska ta 0.5s** så att det blir lite spänning i det hela. Använda funktionen [time.sleep()](https://docs.python.org/2/library/time.html#time.sleep) för att åstadkomma detta.
...
![Pokémon results](/assets/img/poke4.png)

## Del 6 - Statistik

Gör det möjligt för användaren att se statistik över vinster / förluster i spelet. Det är upp till dig hur avancerat du vill göra detta, men som minimum ska antal vinster &amp; antal förluster visas.
